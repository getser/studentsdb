...
urlpatterns = [
    ...
    url(r'^groups/(?P<gid>\d+)/edit/$', views.students_edit, name='groups_edit'),
    url(r'^groups/(?P<gid>\d+)/delete/$', views.students_delete, name='groups_delete'),



    url(r'^journal/$', views.journal, name='journal'),
    url(r'^journal/(?P<jid>\d+)/$', views.journal_id, name='journal_id'),
